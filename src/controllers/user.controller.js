...
const registerUser = asyncHandler(async (req, res) => {
  ...
  // get the avatar from req obj. which is stored on our server using multer
  ...
  // checking here again bcz it is required field in db
  if (!avatar) {
    throw new ApiError(400, "Avatar file is required");
  }
  ...
  // remove the password and refreshToken, if user is created
